...
# Indexes
#
#  index_tekomi_scenarios_on_account_id                (account_id)
#  index_tekomi_scenarios_on_assistant_id              (assistant_id)
#  index_tekomi_scenarios_on_assistant_id_and_enabled  (assistant_id,enabled)
#  index_tekomi_scenarios_on_enabled                   (enabled)
#
class Tekomi::Scenario < ApplicationRecord
  ...
  self.table_name = 'tekomi_scenarios'
  ...
  def resolve_tool_instance(tool_metadata)
    ...
    if tool_metadata[:custom]
      custom_tool = Tekomi::CustomTool.find_by(slug: tool_id, account_id: account_id, enabled: true)
