# Squashed baseline: replaces every migration up to 2026-08-27.
# Generated from db/schema.rb, which stays the source of truth for fresh installs
# (db:chatwoot_prepare loads the schema directly and never replays migrations).
class InitSchema < ActiveRecord::Migration[7.2]
  def up
    ...
    create_table 'agent_sessions' do |t|
      ...
      t.index %w[account_id result_type result_id], name: 'idx_on_account_id_result_type_result_id_ca66c00cd7'
      t.index %w[account_id session_type created_at], name: 'idx_on_account_id_session_type_created_at_c20a14bd4e'
      t.index %w[account_id subject_type subject_id], name: 'idx_on_account_id_subject_type_subject_id_6d60963b3d'
    ...
    create_table 'applied_slas' do |t|
      ...
      t.index %w[account_id sla_policy_id conversation_id], name: 'index_applied_slas_on_account_sla_policy_conversation', unique: true
    ...
    create_table 'assignment_policies' do |t|
      ...
      t.index %w[account_id name], name: 'index_assignment_policies_on_account_id_and_name', unique: true
    ...
    create_table 'audits' do |t|
      ...
      t.index %w[associated_type associated_id created_at], name: 'index_audits_on_associated_and_created_at'
    ...
    create_table 'automation_rule_pending_executions' do |t|
      ...
      t.index %w[automation_rule_id conversation_id episode_key], name: 'uniq_automation_pending_execution_episode', unique: true
      ...
      t.index %w[status due_at], name: 'index_automation_rule_pending_executions_on_status_and_due_at'
      t.index %w[status updated_at], name: 'index_automation_pending_executions_on_status_and_updated_at'
    end
    ...
    create_table 'calls' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[account_id contact_id], name: 'index_calls_on_account_id_and_contact_id'
      t.index %w[account_id conversation_id], name: 'index_calls_on_account_id_and_conversation_id'
      t.index %w[account_id created_at], name: 'index_calls_on_account_id_and_created_at'
      t.index ['message_id'], name: 'index_calls_on_message_id'
      t.index %w[provider provider_call_id], name: 'index_calls_on_provider_and_provider_call_id', unique: true
    end
    ...
    create_table 'campaign_recipients' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[account_id campaign_id], name: 'index_campaign_recipients_on_account_id_and_campaign_id'
      t.index ['account_id'], name: 'index_campaign_recipients_on_account_id'
      t.index %w[campaign_id contact_id], name: 'index_campaign_recipients_on_campaign_id_and_contact_id', unique: true
      t.index %w[campaign_id status], name: 'index_campaign_recipients_on_campaign_id_and_status'
    ...
    create_table 'captain_assistant_responses' do |t|
      ...
      t.index %w[documentable_id documentable_type], name: 'idx_cap_asst_resp_on_documentable'
    ...
    create_table 'captain_custom_tools' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[account_id slug], name: 'index_captain_custom_tools_on_account_id_and_slug', unique: true
    ...
    create_table 'captain_documents' do |t|
      ...
      t.index %w[account_id assistant_id sync_status last_synced_at], name: 'idx_captain_documents_on_account_assistant_sync_stats'
      t.index %w[account_id sync_status], name: 'index_captain_documents_on_account_id_and_sync_status'
    ...
    create_table 'captain_faq_observations' do |t|
      ...
      t.index %w[conversation_id faq_suggestion_id], name: 'idx_captain_faq_observations_on_conversation_and_suggestion', unique: true,
    ...
    create_table 'captain_faq_suggestions' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[account_id assistant_id status language], name: 'idx_cap_faq_suggestions_on_account_assistant_status_language'
    ...
    create_table 'captain_inboxes' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[captain_assistant_id inbox_id], name: 'index_captain_inboxes_on_captain_assistant_id_and_inbox_id', unique: true
    ...
    create_table 'captain_scenarios' do |t|
      ...
      t.index %w[assistant_id enabled], name: 'index_captain_scenarios_on_assistant_id_and_enabled'
    ...
    create_table 'channel_phone' do |t|
      ...
      t.index %w[account_id sip_domain sip_username], name: 'idx_channel_phone_on_account_and_sip_identity', unique: true
    end
    ...
    create_table 'companies' do |t|
      ...
      t.index %w[account_id domain], name: 'index_companies_on_account_and_domain', unique: true, where: '(domain IS NOT NULL)'
      t.index ['account_id'], name: 'index_companies_on_account_id'
      t.index %w[name account_id], name: 'index_companies_on_name_and_account_id'
    end
    ...
    create_table 'contacts', id: :serial do |t|
      ...
      t.index %w[account_id contact_type], name: 'index_contacts_on_account_id_and_contact_type'
      t.index %w[account_id email phone_number identifier], name: 'index_contacts_on_nonempty_fields',
                                                            where: "(((email)::text <> ''::text) OR ((phone_number)::text <> ''::text) OR ((identifier)::text <> ''::text))"
      t.index %w[account_id last_activity_at], name: 'index_contacts_on_account_id_and_last_activity_at',
                                               order: { last_activity_at: 'DESC NULLS LAST' }
      t.index ['account_id'], name: 'index_contacts_on_account_id'
      t.index ['account_id'], name: 'index_resolved_contact_account_id',
                              where: "(((email)::text <> ''::text) OR ((phone_number)::text <> ''::text) OR ((identifier)::text <> ''::text))"
      ...
      t.index %w[name email phone_number identifier], name: 'index_contacts_on_name_email_phone_number_identifier', opclass: :gin_trgm_ops,
                                                      using: :gin
    ...
    create_table 'conversation_outcomes' do |t|
      ...
      t.datetime 'ended_at'
      t.index %w[account_id assistant_id handoff_at], name: 'idx_conversation_outcomes_on_assistant_handoff_at'
      t.index %w[account_id assistant_id resolved_at], name: 'idx_conversation_outcomes_on_assistant_resolved_at'
      t.index %w[account_id assistant_id started_at], name: 'idx_conversation_outcomes_on_assistant_started_at'
      t.index %w[account_id conversation_id started_at], name: 'idx_conversation_outcomes_unique_boundary', unique: true
      t.index %w[account_id conversation_id], name: 'idx_conversation_outcomes_initial_episode', unique: true,
                                              where: "((episode_trigger)::text = 'initial'::text)"
      t.index %w[account_id conversation_id], name: 'idx_conversation_outcomes_open_episode', unique: true, where: '(ended_at IS NULL)'
    ...
    create_table 'conversation_participants' do |t|
      ...
      t.index %w[user_id conversation_id], name: 'index_conversation_participants_on_user_id_and_conversation_id', unique: true
    ...
    create_table 'conversations', id: :serial do |t|
      ...
      t.index %w[account_id id], name: 'index_conversations_on_id_and_account_id'
      t.index %w[account_id inbox_id status assignee_id], name: 'conv_acid_inbid_stat_asgnid_idx'
      t.index %w[account_id status created_at], name: 'index_conversations_on_account_id_status_created_at'
      ...
      t.index %w[identifier account_id], name: 'index_conversations_on_identifier_and_account_id'
      t.index ['inbox_id'], name: 'index_conversations_on_inbox_id'
      t.index ['priority'], name: 'index_conversations_on_priority'
      t.index %w[status account_id], name: 'index_conversations_on_status_and_account_id'
      t.index %w[status priority], name: 'index_conversations_on_status_and_priority'
    ...
    create_table 'data_import_errors' do |t|
      ...
      t.index %w[source_object_type source_object_id], name: 'idx_data_import_errors_on_source'
    end
    ...
    create_table 'data_import_items' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[chatwoot_record_type chatwoot_record_id], name: 'idx_data_import_items_on_record'
      t.index %w[data_import_id source_object_type source_object_id], name: 'idx_data_import_items_on_import_and_source', unique: true
      t.index ['data_import_id'], name: 'index_data_import_items_on_data_import_id'
      t.index %w[source_provider source_object_type source_object_id], name: 'idx_data_import_items_on_source'
    end
    ...
    create_table 'data_import_mappings' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[account_id source_provider source_object_type source_object_id], name: 'idx_data_import_mappings_on_account_and_source',
                                                                                  unique: true
      t.index %w[chatwoot_record_type chatwoot_record_id], name: 'idx_data_import_mappings_on_record'
    ...
    create_table 'email_templates' do |t|
      ...
      t.datetime 'updated_at', null: false
      t.integer 'inbox_id'
      t.index %w[account_id name template_type locale], name: 'index_email_templates_on_account_scope', unique: true,
                                                        where: '((account_id IS NOT NULL) AND (inbox_id IS NULL))'
      t.index %w[inbox_id name template_type locale], name: 'index_email_templates_on_inbox_scope', unique: true,
                                                      where: '(inbox_id IS NOT NULL)'
      t.index ['inbox_id'], name: 'index_email_templates_on_inbox_id'
      t.index %w[name template_type locale], name: 'index_email_templates_on_installation_scope', unique: true,
    ...
    create_table 'inbox_capacity_limits' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[agent_capacity_policy_id inbox_id], name: 'idx_on_agent_capacity_policy_id_inbox_id_71c7ec4caf', unique: true
    ...
    create_table 'inboxes', id: :serial do |t|
      ...
      t.index %w[channel_id channel_type], name: 'index_inboxes_on_channel_id_and_channel_type'
    ...
    create_table 'leaves' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[account_id status], name: 'index_leaves_on_account_id_and_status'
    ...
    create_table 'messages', id: :serial do |t|
      ...
      t.index %w[account_id content_type created_at], name: 'idx_messages_account_content_created'
      t.index %w[account_id created_at message_type], name: 'index_messages_on_account_created_type'
      t.index %w[account_id inbox_id], name: 'index_messages_on_account_id_and_inbox_id'
      t.index ['account_id'], name: 'index_messages_on_account_id'
      t.index ['content'], name: 'index_messages_on_content', opclass: :gin_trgm_ops, using: :gin
      t.index %w[conversation_id account_id message_type created_at], name: 'index_messages_on_conversation_account_type_created'
      t.index ['conversation_id'], name: 'index_messages_on_conversation_id'
      t.index ['created_at'], name: 'index_messages_on_created_at'
      t.index ['inbox_id'], name: 'index_messages_on_inbox_id'
      t.index %w[sender_type sender_id created_at], name: 'index_messages_on_sender_and_created'
    ...
    create_table 'notifications' do |t|
      ...
      t.index %w[user_id account_id snoozed_until read_at], name: 'idx_notifications_performance'
    ...
    create_table 'pbx_call_events' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[pbx_id event_id], name: 'index_pbx_call_events_on_pbx_id_and_event_id', unique: true
      t.index %w[pbx_id linked_id], name: 'index_pbx_call_events_on_pbx_id_and_linked_id'
    ...
    create_table 'phone_calls' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[account_id contact_id], name: 'index_phone_calls_on_account_id_and_contact_id'
      t.index %w[account_id conversation_id], name: 'index_phone_calls_on_account_id_and_conversation_id'
      t.index ['message_id'], name: 'index_phone_calls_on_message_id', unique: true, where: '(message_id IS NOT NULL)'
      t.index %w[pbx_id linked_id], name: 'index_phone_calls_on_pbx_id_and_linked_id', unique: true
    end
    ...
    create_table 'phone_extensions' do |t|
      ...
      t.index %w[inbox_id sip_username], name: 'index_phone_extensions_on_inbox_id_and_sip_username', unique: true
      t.index %w[inbox_id user_id], name: 'index_phone_extensions_on_inbox_id_and_user_id', unique: true
    end
    ...
    create_table 'reporting_events' do |t|
      ...
      t.index %w[account_id name created_at], name: 'reporting_events__account_id__name__created_at'
      t.index %w[account_id name inbox_id created_at], name: 'index_reporting_events_for_response_distribution'
    ...
    create_table 'reporting_events_rollups' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[account_id date dimension_type dimension_id metric], name: 'index_rollup_unique_key', unique: true
      t.index %w[account_id dimension_type date], name: 'index_rollup_summary'
      t.index %w[account_id metric date], name: 'index_rollup_timeseries'
    end
    ...
    create_table 'user_sessions' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[user_id client_id], name: 'index_user_sessions_on_user_id_and_client_id', unique: true
