...
class Base::SendOnChannelService
  ...
  def invalid_message?
    ...
    # Call bubbles are status indicators, not deliverable messages.
    message.private? || outgoing_message_originated_from_channel? || message.content_type.in?(%w[voice_call phone_call])
  end
